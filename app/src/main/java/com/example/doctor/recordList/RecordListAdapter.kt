...
class RecordListAdapter(val arrayList: ArrayList<RecordModel>, private val context: Context) :
    ...
    class ViewHolder(itemView: View, private val context: Context) : RecyclerView.ViewHolder(itemView) {
        fun bindItems(model: RecordModel) {
            ...
            itemView.recordImage.setImageResource(model.image)
        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putIntegerArrayListExtra("List",recordList(arrayList))
    ...
    private fun recordList(list: ArrayList<RecordModel>):ArrayList<Int>{
